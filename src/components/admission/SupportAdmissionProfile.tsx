    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="flex items-center gap-4">
          ...
          <span className="text-purple-600 font-medium">Loading Profile...</span>
        </div>
      </div>
    );
  }
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-500 mb-1">Assigned Branch</label>
                <div className="bg-purple-50 p-3 rounded-lg">
                  <p className="font-medium text-purple-800">{profile.branch.shortName}</p>
                  <p className="text-sm text-purple-600">{profile.branch.legalName}</p>
                </div>
              </div>
              <div>
