  ...
  return (
    <div className="flex items-center justify-end gap-2">
      ...
      <PowerButton
        ...
        className="bg-gradient-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 text-white px-3 py-2 rounded-lg text-sm font-medium shadow-sm hover:shadow-md transition-all duration-200"
      >
