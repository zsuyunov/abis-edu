...
interface ParentAttendanceFiltersProps {
  filters: any;
  timeFilter: string;
...
const ParentAttendanceFilters = ({
  ...
  }, [selectedChildId, filters.academicYearId, filters.subjectId, filters.includeClassAverage, timeFilter]);
  ...
  return (
    <div className="space-y-4">
      ...
      <div className={`grid ${isMobile ? 'grid-cols-1' : 'grid-cols-2 lg:grid-cols-4'} gap-4`}>
        ...
        <div>
          ...
          <label className="flex items-center">
            <input
              type="checkbox"
              checked={filters.includeClassAverage}
              onChange={(e) => handleFilterChange("includeClassAverage", e.target.checked)}
              className="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
            />
            <span className="ml-2 text-sm text-gray-600">Include class average</span>
          </label>
        </div>
      ...
      {(currentView === "charts" || currentView === "records" || currentView === "comparison") && (
      ...
      <div className="text-xs text-gray-500 bg-gray-50 p-3 rounded-md">
        💡 Your child's attendance data is automatically filtered to their assigned branch and class. 
        ...
        {currentView === "comparison" && " Class average comparison helps understand relative performance."}
        ...
        <div className="mt-2 pt-2 border-t border-gray-200">
          🎯 <strong>Parent Tip:</strong> Regular attendance monitoring helps ensure academic success!
          {filters.includeClassAverage && " Class comparisons provide valuable context for your child's performance."}
        </div>
      </div>
    </div>
  );
...
export default ParentAttendanceFilters;
