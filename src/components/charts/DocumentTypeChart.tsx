...
const DocumentTypeChart = ({ data, totalDocuments }: DocumentTypeChartProps) => {
      ...
      return (
        <div className="bg-white p-3 border border-gray-200 rounded-lg shadow-lg">
          ...
          <p className="text-sm text-blue-600">
            <span className="font-semibold">{data.value}</span> documents ({data.percentage}%)
          </p>
        </div>
      );
    }
  ...
  return (
    <div className="bg-white p-4 rounded-lg border border-gray-200">
      <h3 className="text-lg font-semibold mb-4 text-gray-900">Documents by Type</h3>
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-md">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
              <div>
                ...
                <span className="text-blue-600 font-semibold">{totalDocuments}</span>
              </div>
              <div>
