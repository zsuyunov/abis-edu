...
const DoctorMessages = ({ userId }: DoctorMessagesProps) => {
  ...
  const { data: messages, isLoading } = useQuery<Message[]>({
    queryKey: ["doctor-messages", userId, searchTerm, filterType],
    queryFn: async () => {
      ...
      const response = await fetch(`/api/doctor/messages?${params}`);
    ...
    <div className="p-4 md:p-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Medical Communications</h1>
            <p className="text-gray-600">Communicate with staff about health matters</p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search medical messages..."
                value={searchTerm}
      ...
      {messages && messages.length > 0 ? (
        ...
        <div className="text-center py-16">
          <div className="max-w-md mx-auto">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">No Medical Messages</h3>
            <p className="text-gray-600 mb-6">
              No medical messages found. Start communicating about health matters with staff and administration.
            </p>
            <button
              onClick={() => setShowComposeModal(true)}
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200 flex items-center justify-between">
              <h2 className="text-xl font-semibold text-gray-900">Compose Medical Message</h2>
              <button
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <option value="meal_feedback">Meal Plan Feedback</option>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Enter medical message subject"
                  />
                </div>
                <div>
                  ...
                  <textarea
                    rows={6}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                    placeholder="Enter your medical message or health recommendations"
                  />
                </div>
            ...
            <div className="p-6">
              <div className="mb-4">
                ...
                <div className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${
                  ...
                  Medical - {selectedMessage.status}
                </div>
              </div>
