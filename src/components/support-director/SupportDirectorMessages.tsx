...
interface SupportDirectorMessagesProps {
  userId: string;
}

const SupportDirectorMessages = ({ userId }: SupportDirectorMessagesProps) => {
  ...
  const { data: messages, isLoading } = useQuery<Message[]>({
    queryKey: ["support-director-messages", userId, searchTerm, filterType],
    queryFn: async () => {
      ...
      const response = await fetch(`/api/support-director/messages?${params}`);
    ...
    <div className="p-4 md:p-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Administrative Messages</h1>
      ...
      {messages && messages.length > 0 ? (
        ...
        <div className="text-center py-16">
          <div className="max-w-md mx-auto">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">No Messages</h3>
            <p className="text-gray-600 mb-6">
              No messages found. Start communicating with staff and administration.
            </p>
            <button
              onClick={() => setShowComposeModal(true)}
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-600 to-teal-600 text-white rounded-lg hover:from-green-700 hover:to-teal-700 transition-colors"
            >
              <Plus className="w-4 h-4" />
              Send Message
            </button>
      ...
      {selectedMessage && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-gradient-to-br from-green-500 to-teal-500 rounded-full flex items-center justify-center text-white text-sm font-medium">
            ...
            <div className="p-6">
              <div className="mb-4">
                ...
                <div className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${
                  ...
                  Administrative - {selectedMessage.status}
                </div>
              </div>
              ...
              <div className="flex justify-end gap-3 pt-6 border-t border-gray-200 mt-6">
                ...
                <button className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-600 to-teal-600 text-white rounded-lg hover:from-green-700 hover:to-teal-700 transition-colors">
...
export default SupportDirectorMessages;
