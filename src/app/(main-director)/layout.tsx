import MainDirectorMenu from "@/components/MainDirectorMenu";
...
export default function MainDirectorLayout({
  children,
}: Readonly<{
          ...
          <div className="h-screen flex">
            ...
            <div className="w-[14%] md:w-[8%] lg:w-[16%] xl:w-[14%] p-4 bg-white border-r border-gray-200">
              ...
              >
                ...
                <span className="hidden lg:block font-bold text-gray-800">Main Director</span>
              </Link>
              <MainDirectorMenu />
            </div>
            {/* RIGHT CONTENT */}
