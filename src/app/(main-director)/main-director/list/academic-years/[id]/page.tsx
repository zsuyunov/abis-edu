  ...
  if (!academicYear) {
    return (
      <div className="bg-white p-4 rounded-md m-4">
        ...
        <Link href="/main-director/list/academic-years" className="text-blue-600 text-sm">Back to list</Link>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white p-4 rounded-md m-4">
      <div className="flex items-center justify-between mb-4">
        ...
        <Link href="/main-director/list/academic-years">
