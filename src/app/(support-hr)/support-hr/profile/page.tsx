...
const SupportHRProfilePage = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        const response = await fetch("/api/support-hr/profile");
    ...
    <div className="p-4 m-4 mt-0">
      <div className="bg-white p-6 rounded-md">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-semibold text-gray-800">Support HR Profile</h1>
          <button 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-900 font-semibold text-orange-600">Support HR</p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-900 font-semibold">{profile?.branchName || "N/A"}</p>
            </div>
...
export default SupportHRProfilePage;
