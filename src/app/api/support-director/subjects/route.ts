...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ subjects, totalPages: Math.ceil(count / ITEM_PER_PAGE), currentPage: page, totalItems: count });
  } catch (e) {
    console.error(e);
...
export async function POST(request: NextRequest) {
  try {
    ...
    const row = await prisma.subject.create({ data: { name } });
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    const updated = await prisma.subject.updateMany({ where: { id }, data: { name } });
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    const deleted = await prisma.subject.updateMany({ where: { id }, data: { archivedAt: new Date() } });
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const restored = await prisma.subject.updateMany({ where: { id }, data: { archivedAt: null } });
