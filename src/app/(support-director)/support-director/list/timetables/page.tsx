...
const TimetablesPage = async ({
  ...
  const columns = [
    ...
    { header: "Date & Time", accessor: "datetime", className: "hidden lg:table-cell" },
    { header: "Room", accessor: "room", className: "hidden lg:table-cell" },
      ...
      {role === "support_director" && (
        <td>
          <div className="flex items-center gap-2">
            <Link href={`/support-director/list/timetables/${item.id}`}>
            ...
            {item.status === "ACTIVE" ? (
              <FormContainer table="timetable" type="archive" data={item} />
            ) : (
              <FormContainer table="timetable" type="restore" data={item} />
            )}
            <FormContainer table="timetable" type="delete" data={item} />
          </div>
        </td>
      )}
    </tr>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          ...
          <div className="flex items-center gap-4 self-end">
            ...
            {role === "support_director" && <FormContainer table="timetable" type="create" />}
          </div>
        </div>
      </div>
