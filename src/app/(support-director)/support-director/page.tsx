import SupportDirectorDashboard from "@/components/support-director/SupportDirectorDashboard";
...
const SupportDirectorDashboardPage = ({
  searchParams,
}: {
...
export default SupportDirectorDashboardPage;