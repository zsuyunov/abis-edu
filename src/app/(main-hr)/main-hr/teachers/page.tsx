  ...
  const fetchTeachers = async () => {
    try {
      ...
      const response = await fetch(
        `/api/main-hr/teachers?page=${currentPage}&search=${searchTerm}`
      );
  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
      ...
      <div className="flex items-center justify-between mb-4">
        <h1 className="hidden md:block text-lg font-semibold">Teachers Management (All Branches)</h1>
...
export default MainHRTeachersPage;
